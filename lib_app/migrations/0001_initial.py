    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(help_text='Select a genre for this book', to='lib_app.genre')),
                ('language', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='lib_app.language')),
            ],
        ),
        migrations.CreateModel(
            name='Reviews',
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lib_app.student')),
            ],
        ),
        migrations.CreateModel(
            name='Borrower',
